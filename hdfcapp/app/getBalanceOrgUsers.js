...
async function getBalanceOrgUsers(userId, bank) {
	let response;
	try {
		...
		try {
            ...
            console.log('\n**************** As HDFC Client ****************');
            console.log('\n--> Evaluate Transaction: GetAllUserBalanceForOrg');
            result = await contract.evaluateTransaction('GetAllUserBalanceForOrg', bank);
...
//module.exports = getBalanceOrgUsers;
getBalanceOrgUsers('dayal',"HDFC");

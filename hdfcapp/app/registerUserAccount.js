...
async function registerUserAccount(userId, bank) {
	let response;
	try {
		...
		try {
            ...
            console.log('\n**************** As HDFC Client ****************');
            console.log('\n--> Submit Transaction: RegisterUserAccount');
            result = await contract.submitTransaction('RegisterUserAccount', `${userId}@${bank}`, bank);
...
registerUserAccount('dayal',"HDFC");

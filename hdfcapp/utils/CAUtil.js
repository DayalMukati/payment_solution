...
const hdfcadminUserId = 'admin';
const hdfcadminUserPasswd = 'adminpw';
const sbiadminUserId = 'sbicaadmin';
const sbiadminUserPasswd = 'sbicaadminpw';
let adminUserId;
let adminUserPasswd;
